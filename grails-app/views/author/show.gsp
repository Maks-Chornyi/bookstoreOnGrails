...
<div class="general-info">
    <g:if test="${author.books.size() > 0}">
        ...
        <p>Most <strong>successful</strong>book is: <strong>${mostSuccessfulBook.title}</strong> (<strong>${countOfCopiesOfMostSuccessfulBook}</strong> copies)</p>
        <p><strong>Unsuccessful</strong> book is: <strong>${unsuccessfulBook.title}</strong> (<strong>${countofCopiesOfUnsuccessfulBook}</strong> copies)</p>
        <p><strong>First</strong> published book is: <strong>${firstBookOfAuthor.title}</strong> (published at <g:formatDate format="yyyy-MM-dd" date="${publishDateOfFirstBook}"/>)</p>
        <p><strong>Last</strong> published book is: <strong>${lastBookOfAuthor.title}</strong> (published at <g:formatDate format="yyyy-MM-dd" date="${publishDateOfLastBook}"/>)</p>
    </g:if>
    <g:else>
...
<div class="edit-author">
    <g:form controller="author" action="update" class="updateAuthorForm">
