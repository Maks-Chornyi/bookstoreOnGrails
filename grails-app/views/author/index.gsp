...
<g:form action="deleteAuthor" class="deleteAuthorForm">
    ...
    <div id="dialog" title="Author info" hidden="hidden">
        <p>Name: <strong id="authorNameDialog"></strong></p>
        <p>Info: <strong id="authorInfoDialog"></strong></p>
        <p>Address: <strong id="addressDialog"></strong></p>
        <p>Birthday: <strong id="birthdayDialog"></strong></p>
        <p>Amount of Books: <strong id="countOfBooksDialog"></strong></p>
    </div>
