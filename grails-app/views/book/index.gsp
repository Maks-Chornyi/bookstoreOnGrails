...
<body>
    ...
    <div id="addNewBookButton" title="Add New Book" hidden="hidden">
        <g:form controller="book" action="addNewBook">
            <table class="add-book-table">
                ...
                <tr>
                    ...
                    <td><g:textField name="ISBN"/></td>
                </tr>
                <tr>
                    <td><label>Publish date: </label></td>
                    <td><g:datePicker precision="day" name="publishDate"/></td>
                </tr>
                <tr>
                    <td><label>Count of copies: </label></td>
